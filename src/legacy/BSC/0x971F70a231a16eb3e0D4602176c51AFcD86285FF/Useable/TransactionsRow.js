  ...
  return (
    ...
    <React.Fragment>  
      <tr className="cursor-pointer mt-2">  
        ...
        <td title={transactions.transactionHash}><a href={'https://bscscan.com/tx/'+ transactions.transactionHash} target='blank'>{transactions.transactionHash.slice(15) + '...'}</a></td>
        <td title={transactions.blockNumber}><a href={'https://bscscan.com/block/'+ transactions.blockNumber} target='blank'>{transactions.blockNumber}</a></td>
			</tr>               
